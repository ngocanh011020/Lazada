...
public class MainActivity extends AppCompatActivity {
    ...
    private List<CardItem> getListData() {
        ...
        CardItem cardItem1=new CardItem(R.drawable.xe,"Phạm Ngọc Anh","");
        CardItem cardItem3=new CardItem(R.drawable.xe2,"Porche 911","");
        CardItem cardItem4=new CardItem(R.drawable.xe3,"Mclauren 720S","");
        CardItem cardItem5=new CardItem(R.drawable.xe4,"Mclauren 650S","");
        CardItem cardItem6=new CardItem(R.drawable.xe,"Lamboghini Aventador","");
        CardItem cardItem7=new CardItem(R.drawable.xe2,"Porche 911","");
